          ...
          suaHinhAnhThuoc(
            ...
            (err) => {
              setTB({
                ...
                content: `Đã sửa thuốc với ID: ${idThuoc} nhưng không thể sửa hình ảnh`,
              });
              handleShowModal();
            }
          );
  ...
  useEffect(() => {
    ...
    getThuocById(
      ...
      (res) => {
        ...
        setIS(`${BASE_URL}/images/${res.data.hinhAnh}`);
      },
      (err) => {}
    );
    getCTDuocChatByIdThuoc(
  ...
  useEffect(() => {
    if (dsDuocChat && tpDuocChat && isInit) {
      ...
      const _newTPDC = tpDuocChat.map((tpdc) => {
        ...
        _newDSDC = _newDSDC.filter((dc) => dc.id != _idDuocChat);
        return {
          ...tpdc,
        ...
        <div className={style.themThuoc}>
          ...
          <div className={style.body}>
            <div className={style.inputGroup}>
              ...
              />
              {errTenThuoc && (
                <span className={style.error}>{errTenThuoc}</span>
              )}
            </div>
            <div className={style.inputGroup}>
